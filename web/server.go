...
import (
	...
	"librebucket/dist" // This package will be generated by golte
...
func StartServer() {
	...
	// API endpoints
	r.Post("/api/v1/users/register", userRegisterHandler)
	r.Post("/api/v1/users/{username}/apikeys", userAPIKeyHandler) // Catches /api/v1/users/{username}/apikeys
	r.Post("/api/v1/git/create", apiCreateRepoHandler)
